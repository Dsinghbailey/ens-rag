...
# db_url = urlparse(DB_CONN_STRING)
# if not all(
#     [db_url.scheme, db_url.hostname, db_url.username, db_url.password, db_url.path]
# ):
...
#     table_name="processed_chunks",
#     schema_name="public",
#     embed_dim=VOYAGE_DIMENSION,
# )
